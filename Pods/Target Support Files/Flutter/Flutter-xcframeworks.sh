...
install_xcframework "${PODS_ROOT}/../Flutter/flutterengineexample_module/.ios/Flutter/engine/Flutter.xcframework" "Flutter" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
